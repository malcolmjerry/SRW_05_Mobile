...
public class AbilityController3 : MonoBehaviour {

  public Color32 unSelectedColor;
  public Color32 SelectedColor;

  //public GameObject m_AbilityPrefab;
  //public GameObject myAbilityCanvas;
  ...
  void Awake() {
    headList.Add( transform.Find( "CommonHead" ) );
    headList.Add( transform.Find( "RobotHead" ) );
    headList.Add( transform.Find( "PilotHead" ) );
    headList.Add( transform.Find( "WeaponHead" ) );

    bodyList.Add( transform.Find( "CommonBody" ) );
    bodyList.Add( transform.Find( "RobotBody" ) );
    bodyList.Add( transform.Find( "PilotBody" ) );
    bodyList.Add( transform.Find( "WeaponBody" ) );
  ...
  private void setHead() {
    headList.ForEach( tf => tf.gameObject.SetActive( true ) );
  ...
  void closeAll() {
    headList.ForEach( tf => tf.gameObject.SetActive( false ) );
    bodyList.ForEach( tf => tf.gameObject.SetActive( false ) );
  }
}
