...
public abstract class SelectableMenuT<TNext> : MonoBehaviour {
  ...
  public void Setup( Action callback, Action<TNext> next = null, bool closeSelf = true ) {
