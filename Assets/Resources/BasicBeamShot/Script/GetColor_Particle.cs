...
public class GetColor_Particle : MonoBehaviour {
    ...
    var main = ps.main;
    main.startColor = this.transform.root.gameObject.GetComponent<BeamParam>().BeamColor;
    main.startSize = this.transform.root.gameObject.GetComponent<BeamParam>().Scale;
  }
